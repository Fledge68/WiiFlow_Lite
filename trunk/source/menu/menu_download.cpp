...
int CMenu::_coverDownloader(bool missingOnly)
{
	...
	safe_vector<string> fmtURLCBox = stringToVector(m_cfg.getString("GENERAL", "url_custom_full_covers", FMT_CBPIC_URL), '|');
	safe_vector<string> fmtURLCFlat = stringToVector(m_cfg.getString("GENERAL", "url_custom_flat_covers", FMT_CPIC_URL), '|');
...
void CMenu::_initDownloadMenu(CMenu::SThemeData &theme)
{
	...
	m_downloadBtnEN = _addButton(theme, "DOWNLOAD/EN", theme.btnFont, L"", 60, 220, 120, 56, theme.selubtnFontColor);
	m_downloadBtnJA = _addButton(theme, "DOWNLOAD/JA", theme.btnFont, L"", 195, 220, 120, 56, theme.selubtnFontColor);
	m_downloadBtnFR = _addButton(theme, "DOWNLOAD/FR", theme.btnFont, L"", 330, 220, 120, 56, theme.selubtnFontColor);
	m_downloadBtnDE = _addButton(theme, "DOWNLOAD/DE", theme.btnFont, L"", 465, 220, 120, 56, theme.selubtnFontColor);
	m_downloadBtnES = _addButton(theme, "DOWNLOAD/ES", theme.btnFont, L"", 60, 280, 120, 56, theme.selubtnFontColor);
	m_downloadBtnIT = _addButton(theme, "DOWNLOAD/IT", theme.btnFont, L"", 195, 280, 120, 56, theme.selubtnFontColor);
	m_downloadBtnNL = _addButton(theme, "DOWNLOAD/NL", theme.btnFont, L"", 330, 280, 120, 56, theme.selubtnFontColor);
	m_downloadBtnPT = _addButton(theme, "DOWNLOAD/PT", theme.btnFont, L"", 465, 280, 120, 56, theme.selubtnFontColor);
	m_downloadBtnRU = _addButton(theme, "DOWNLOAD/RU", theme.btnFont, L"", 60, 340, 120, 56, theme.selubtnFontColor);
	m_downloadBtnKO = _addButton(theme, "DOWNLOAD/KO", theme.btnFont, L"", 195, 340, 120, 56, theme.selubtnFontColor);
	m_downloadBtnZHCN = _addButton(theme, "DOWNLOAD/ZHCN", theme.btnFont, L"", 330, 340, 120, 56, theme.selubtnFontColor);
	m_downloadBtnAU = _addButton(theme, "DOWNLOAD/AU", theme.btnFont, L"", 465, 340, 120, 56, theme.selubtnFontColor);	
	m_downloadBtnENs = _addSelButton(theme, "DOWNLOAD/ENS", theme.btnFont, L"", 60, 220, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnJAs = _addSelButton(theme, "DOWNLOAD/JAS", theme.btnFont, L"", 195, 220, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnFRs = _addSelButton(theme, "DOWNLOAD/FRS", theme.btnFont, L"", 330, 220, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnDEs = _addSelButton(theme, "DOWNLOAD/DES", theme.btnFont, L"", 465, 220, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnESs = _addSelButton(theme, "DOWNLOAD/ESS", theme.btnFont, L"", 60, 280, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnITs = _addSelButton(theme, "DOWNLOAD/ITS", theme.btnFont, L"", 195, 280, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnNLs = _addSelButton(theme, "DOWNLOAD/NLS", theme.btnFont, L"", 330, 280, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnPTs = _addSelButton(theme, "DOWNLOAD/PTS", theme.btnFont, L"", 465, 280, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnRUs = _addSelButton(theme, "DOWNLOAD/RUS", theme.btnFont, L"", 60, 340, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnKOs = _addSelButton(theme, "DOWNLOAD/KOS", theme.btnFont, L"", 195, 340, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnZHCNs = _addSelButton(theme, "DOWNLOAD/ZHCNS", theme.btnFont, L"", 330, 340, 120, 56, theme.selsbtnFontColor);
	m_downloadBtnAUs = _addSelButton(theme, "DOWNLOAD/AUS", theme.btnFont, L"", 465, 340, 120, 56, theme.selsbtnFontColor);
